...
//Create an admin object
    ...
    //****************************************************************DDOOOONNNNNEEEEEE
    public HashTable<Category> getCategories(){
        HashTable<Category> categories = new HashTable<>();
    ...
    //*****************************************************************DOOOOOOONNNNNEEEEEEEEE
    public HashTable<Product> getProducts(){
        HashTable<Product> products = new HashTable<>();
    ...
    public HashTable<Customer> getCustomers(){
        HashTable<Customer> customers = new HashTable<>();
    ...
    //return and array list of  all customers objects in the database
    //***************************************************************************DOOOOONEEEEEEEEE
    public HashTable<Cashier> getCashiers(){
        HashTable<Cashier> cashiers = new HashTable<>();
