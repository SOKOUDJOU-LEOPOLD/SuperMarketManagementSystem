...
public class CategoryManagementController implements Initializable {
    ...
    private HashTable<Category> categoriesList = new HashTable<>();
    ...
    void onSearch(MouseEvent event) {
        ...
        for(Category category:categoriesList.getTableList()){
   ...
   //initial filtered list
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        list = FXCollections.observableArrayList(categoriesList.getTableList());
