...
public class ProductManagementController implements Initializable {
  ...
  @FXML
    ...
    private HashTable<Product> productsList = new HashTable<>();
    ...
    void onSearch(MouseEvent event) {
        ...
        for(Product product:productsList.getTableList()){
   ...
   //initial filtered list
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        list = FXCollections.observableArrayList(productsList.getTableList());
